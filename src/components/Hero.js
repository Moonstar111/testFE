    ...
    <div>
      <section id="hero" >
        <div className='hero_title'>
          ...
          <div className='hero_text'>
            ...
            {/* <h2 className='orange_neon'>An Eth - Dero Bridge </h2> */}
            <h2 class=" orange_neon typewrite type_font" data-period="2000" data-type='[ "Eth - Dero Bridge", "Solving Privacy", "Dero:Homomorphic Encrypted blockchain" ]'>
      ...
      <div>Account: {account ? account : null}</div>
            ...
            <div className="container">
              {account ? <button className=" neon_btn" onClick={disconnect}>Disconnect</button> : <button onClick={handleButtonClick} type="button" className=" neon_btn ">Connect Wallet</button>
              }

              {!account && open && (
                <div class="dropdown ">
                  <ul className="wallet_list " >
                    <button className="wallet " onClick={() => { activate(CoinbaseWallet) }}>Coinbase Wallet</button>
                    <button className="wallet" onClick={connectInjected}>Metamask</button>
                    <button className="wallet" onClick={connectWalletConnect}>Wallet Connect</button>
